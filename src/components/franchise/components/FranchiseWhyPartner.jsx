    ...
    <section className="bg-white py-16 sm:py-24">
      <div className="max-w-[1350px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col items-center mb-12 sm:mb-16 text-center">
          <h2 className="font-khand text-4xl sm:text-5xl font-extrabold uppercase tracking-tight text-[#050D1A]">
            {title}
          </h2>
          <div className="w-20 h-[3px] bg-[#E11922] mt-3" />
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
          {items.map((item) => (
            <div
              key={item.id}
              className="bg-white p-6 sm:p-8 border border-gray-100 border-l-4 border-l-[#E11922] hover:border-l-[#E11922] shadow-sm hover:shadow-md hover:-translate-y-0.5 transition-all duration-300 flex flex-col justify-start items-start gap-4 rounded-sm"
            >
              {/* Icon Container */}
