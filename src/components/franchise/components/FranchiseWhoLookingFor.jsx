      ...
      <div className="max-w-[1350px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 sm:gap-12 items-center">
          ...
          <div className="lg:col-span-6 space-y-6 sm:space-y-8">
            {/* Title */}
            <div>
              <h2 className="font-khand text-4xl sm:text-5xl font-extrabold uppercase tracking-tight text-[var(--apt-navy)] leading-none mb-4">
                {title}
              </h2>
              <div className="w-20 h-[3px] bg-[var(--apt-red)]" />
            </div>
          ...
          <div className="lg:col-span-6 h-full min-h-[350px] sm:min-h-[450px] relative">
            <div className="w-full h-full relative border border-gray-100 shadow-xl rounded-2xl overflow-hidden bg-white/5 group">
              <img
                src={image}
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-[var(--apt-navy)]/20 via-transparent to-transparent pointer-events-none" />
            </div>
          </div>
        </div>
