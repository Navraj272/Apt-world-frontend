...
function AboutUs() {
  ...
  return (
    <div id="about" className="w-full">
      {/* 1. Hero Section */}
      <section className="relative min-h-[70vh] flex items-center bg-[#050D1A] text-white pt-28 pb-20 overflow-hidden">
        {/* Background Image with Dark Industrial Overlay */}
        <div className="absolute inset-0 z-0">
          <img
            src="/assets/png/hero_industrial_bg.png"
            alt="Industrial Background"
            className="w-full h-full object-cover object-center opacity-25 select-none pointer-events-none grayscale"
          />
          <div className="absolute inset-0 bg-gradient-to-t from-[#050D1A] via-[#050D1A]/80 to-[#050D1A]/95 z-10" />
        </div>
        ...
        <div className="relative z-20 max-w-[1350px] w-full mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-[750px] space-y-6">
            {/* Established Badge */}
            <div className="inline-block bg-[#E11922] px-3 py-1 rounded-sm">
            ...
            <h1 className="font-khand text-5xl sm:text-7xl md:text-8xl font-black uppercase tracking-tight leading-[0.95] text-white">
              THE NAME YOU <br />
              <span className="text-[#E11922]">CAN TRUST</span>
            </h1>

            {/* Description */}
            <p className="font-montserrat text-sm sm:text-base md:text-lg text-gray-300 leading-relaxed max-w-[620px] font-medium pt-2">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-4">
            {stats.map((stat, idx) => (
              <div key={idx} className="flex items-start gap-4">
                ...
                <div className="w-[3px] h-12 bg-[#E11922] shrink-0" />
                <div className="space-y-1">
                  <div className="font-outfit text-3xl sm:text-4xl font-extrabold tracking-tight text-gray-900 leading-none">
                    {stat.value}
                  </div>
      ...
      <section className="bg-[#F8F9FA] py-20 sm:py-28 text-gray-900">
        <div className="max-w-[1350px] mx-auto px-4 sm:px-6 lg:px-8">
          {/* Header Title with underline */}
          <div className="mb-12 sm:mb-16">
            <h2 className="font-khand text-4xl sm:text-5xl font-extrabold uppercase tracking-tight text-gray-900">
              OUR INFRASTRUCTURE
            </h2>
            <div className="w-16 h-[3px] bg-[#E11922] mt-3" />
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 sm:gap-8">
            ...
            <div className="lg:col-span-2 bg-white p-8 sm:p-10 border border-gray-100 rounded-sm shadow-md hover:shadow-lg transition-all duration-300 relative overflow-hidden group">
              <div className="relative z-10 max-w-[70%] space-y-4">
                <div className="p-3 bg-[#E11922]/5 rounded-sm border border-[#E11922]/10 w-fit">
                  <svg className="w-6 h-6 text-[#E11922]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
                ...
                <h3 className="font-khand text-2xl sm:text-3xl font-extrabold tracking-wider text-gray-900 group-hover:text-[#E11922] transition-colors duration-300">
                  PAN INDIA NETWORK
                </h3>
            ...
            <div className="bg-[#0B1220] p-8 sm:p-10 rounded-sm shadow-md hover:shadow-lg transition-all duration-300 relative overflow-hidden group text-white">
              <div className="space-y-4">
                <div className="p-3 bg-white/5 rounded-sm border border-white/10 w-fit group-hover:bg-[#E11922]/10 group-hover:border-[#E11922]/30 transition-all duration-300">
                  <svg className="w-6 h-6 text-[#E11922]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
            ...
            <div className="bg-white p-8 sm:p-10 border border-gray-100 rounded-sm shadow-md hover:shadow-lg transition-all duration-300 relative overflow-hidden group">
              <div className="space-y-4">
                <div className="p-3 bg-[#E11922]/5 rounded-sm border border-[#E11922]/10 w-fit">
                  <svg className="w-6 h-6 text-[#E11922]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
            ...
            <div className="lg:col-span-2 bg-[#ECEFF1] rounded-sm shadow-md hover:shadow-lg transition-all duration-300 overflow-hidden group flex flex-col md:flex-row">
              {/* Image side */}
              ...
              <div className="md:w-1/2 p-8 sm:p-10 flex flex-col justify-center space-y-4">
                <h3 className="font-khand text-2xl sm:text-3xl font-extrabold tracking-wider text-gray-900">
      ...
      <section className="bg-[#060F1E] text-white py-20 sm:py-28 overflow-hidden relative">
        <div className="max-w-[1350px] mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
            ...
            <div className="lg:col-span-7 space-y-8 sm:space-y-10">
              <div className="space-y-4">
                <h2 className="font-khand text-4xl sm:text-6xl font-bold uppercase tracking-tight text-white leading-[0.95]">
                  25+ YEARS OF <span className="text-[#E11922]">TECHNICAL AUTHORITY</span>
                </h2>
              ...
              <div className="space-y-6 pt-4 border-t border-white/10 max-w-[580px]">
                ...
                <div className="flex items-start gap-4 group">
                  <div className="w-10 h-10 rounded-full bg-[#E11922] flex items-center justify-center shrink-0 shadow-md shadow-[#E11922]/20 group-hover:scale-110 transition-transform duration-300">
            ...
            <div className="lg:col-span-5 relative group mt-6 lg:mt-0">
              {/* Graphic borders */}
              <div className="absolute -top-4 -left-4 w-20 h-20 border-t-2 border-l-2 border-[#E11922]/40 pointer-events-none transition-all duration-300 group-hover:-top-2 group-hover:-left-2" />
              <div className="absolute -bottom-4 -right-4 w-20 h-20 border-b-2 border-r-2 border-[#E11922]/40 pointer-events-none transition-all duration-300 group-hover:-bottom-2 group-hover:-right-2" />

              <div className="relative overflow-hidden rounded-sm bg-gray-900 border border-white/10 shadow-2xl aspect-[4/5]">
                <img
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-[#060F1E]/50 via-transparent to-transparent pointer-events-none" />

                {/* Overlapping Red Box badge */}
                <div className="absolute bottom-0 left-0 bg-[#E11922] p-6 sm:p-8 max-w-[180px] flex flex-col justify-center shadow-lg border-r border-t border-[#060F1E]/20 select-none">
        ...
        <div className="max-w-[1350px] mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-12 sm:space-y-16">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 text-left">
            {values.map((val, idx) => (
              <div
                key={idx}
                className="bg-white p-8 border border-gray-100 rounded-sm shadow-md hover:shadow-lg hover:border-[#E11922]/20 hover:-translate-y-1 transition-all duration-300 flex flex-col justify-between group"
              >
                <div className="space-y-4">
                  {/* Icon */}
                  <div className="p-3 bg-[#E11922]/5 rounded-sm border border-[#E11922]/10 w-fit group-hover:bg-[#E11922]/10 group-hover:border-[#E11922]/25 transition-all duration-300">
                    {val.icon}
                  </div>
                  {/* Title */}
                  <h3 className="font-khand text-xl sm:text-2xl font-extrabold tracking-wider text-gray-900 group-hover:text-[#E11922] transition-colors duration-300">
                    {val.title}
                  </h3>
                  {/* Description */}
                  <p className="font-montserrat text-xs sm:text-sm text-gray-500 leading-relaxed">
