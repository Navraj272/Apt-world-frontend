    ...
    <section className="relative min-h-[65vh] flex items-center bg-[var(--apt-navy)] text-white pt-28 pb-20 overflow-hidden">
      ...
      <div className="relative z-20 max-w-[1350px] w-full mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-6">
        ...
        <div className="flex flex-wrap items-center justify-center gap-3 pt-4">
          <a
            href="tel:9699429699"
            className="flex items-center gap-2 bg-white/5 border border-white/10 hover:border-[var(--apt-red)]/50 hover:bg-[var(--apt-red)]/10 rounded-full px-4 py-2 transition-all duration-200"
          >
            <svg className="w-3.5 h-3.5 text-[var(--apt-red)]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
              <path strokeLinecap="round" strokeLinejoin="round" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.94.725l.548 2.2a1 1 0 01-.321.988l-1.305.98a10.582 10.582 0 004.872 4.872l.98-1.305a1 1 0 01.988-.321l2.2.548a1 1 0 01.725.94V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
            </svg>
            <span className="font-montserrat text-xs font-semibold text-gray-300">9699429699</span>
          </a>
          <a
          ...
          >
            ...
            <span className="font-montserrat text-xs font-semibold text-gray-300">info.aptworld@gmail.com</span>
          </a>
          <div className="flex items-center gap-2 bg-white/5 border border-white/10 rounded-full px-4 py-2">
            ...
            <span className="font-montserrat text-xs font-semibold text-gray-300">Indore, MP, India</span>
          </div>
        </div>
      </div>
    </section>
