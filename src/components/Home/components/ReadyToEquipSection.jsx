  ...
  return (
    <section id="franchise" className="bg-[var(--apt-offwhite)] py-16 sm:py-24">
      <div className="max-w-[1350px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div 
          className="relative bg-[var(--apt-navy)] text-white p-8 sm:p-12 md:p-16 border border-white/5 shadow-2xl overflow-hidden rounded-3xl"
          style={{
        ...
        >
          ...
          <div className="relative z-10 flex flex-col lg:flex-row lg:items-center justify-between gap-10">
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-4">
              <a
                href="/contact"
                className="text-center font-montserrat text-xs font-bold tracking-widest text-white bg-[var(--apt-red)] px-6 py-3 rounded-xl hover:bg-white hover:text-[var(--apt-red)] border border-transparent transition-all duration-300 shadow-lg shadow-[var(--apt-red)]/15 uppercase"
              >
                REQUEST DISCUSSION
              </a>
              <a
